...
var resume_url="https://shubham-jain-portfolio.web.app/";
var website_url="https://shubham-jain-portfolio.web.app/";
var gmail_url="";
var inst_text;
var bug;
var bug_tween;
...
//	game.load.onLoadStart.add(loadStart, this);
  ...
  //  game.stage.scale.startFullScreen();
   ...
   //game.canvas.addEventListener('touchenter', function(){ console.log("You touched here!!");}, false);
	...
	hill1=game.add.sprite(3000,h-300+400,'hill');
	...
	*/
	...
	game.add.sprite(12200,h-325,'games');
	...
	game.add.sprite(13500,h-325,'harddrive');
...
/*
	...
	*/ 
	...
	game.add.text(base7+720,h-120,"Click /Tap the Clouds to open Profiles.",style_white);
...
//	hero.body.gravity.y=10000;
	...
	game.add.text(w-120,100,"Shubham's Portfolio",{font:"10px Roboto",fill:"#000"}).fixedToCamera=true;
